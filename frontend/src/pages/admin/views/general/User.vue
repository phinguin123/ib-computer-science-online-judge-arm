<template>
  <div class="view">
    ...
    <el-dialog :title="$t('m.User_Info')" :visible.sync="showUserDialog" :close-on-click-modal="false">
      <el-form :model="user" :rules="userRules" ref="userForm" label-width="120px" label-position="left">
        <el-row :gutter="20">
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="Confirm Password" prop="passwordConfirm">
              <el-input v-model="user.passwordConfirm" type="password" show-password></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      saveUser () {
        this.$refs.userForm.validate((valid) => {
          ...
          api.editUser(userData).then(res => {
            // Update list
      ...
      openUserDialog (id) {
        ...
        api.getUser(id).then(res => {
          this.user = Object.assign({}, res.data.data, { password: '', passwordConfirm: '' })
          this.user.real_tfa = this.user.two_factor_auth
          // Clear validation when opening dialog
          this.$nextTick(() => {
    ...
    watch: {
      ...
      'user.password' () {
        ...
        if (this.$refs.userForm && this.user.passwordConfirm) {
