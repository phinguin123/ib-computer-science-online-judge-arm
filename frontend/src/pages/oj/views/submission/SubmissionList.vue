...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      // Remove submitting status and two others
    ...
    methods: {
      ...
      // Change route, request data by listening to route changes, this creates route history, user can return and previous state will be saved
      changeRoute () {
