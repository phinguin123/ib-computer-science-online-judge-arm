    ...
    methods: {
      ...
      applyToChart (rankData) {
        ...
        rankData.forEach(rank => {
          ...
          // Extract the time of AC problems
          let timeData = []
      ...
      applyToTable (data) {
        ...
        // Extract corresponding problem_id from submission_info and put it into parent object, mainly to adapt to iview table's data format
      ...
      addTableColumns (problems) {
        // Add table column based on problems
