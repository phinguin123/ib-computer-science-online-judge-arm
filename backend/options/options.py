...
class my_property:
    ...
    def __get__(self, obj, cls):
        ...
        if self.ttl:
            ...
            # If conditional cache is defined, ttl is a function that returns how long to cache; return 0 means don't cache
            if callable(self.ttl):
                # If conditional cache says don't cache, return directly, don't set local
