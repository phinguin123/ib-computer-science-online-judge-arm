...
def check_contest_password(password, contest_password):
    ...
    if password == contest_password:
        ...
        # Password in the form of sig#timestamp is also supported, but not provided in the interface
...
def check_contest_permission(check_type="details"):
    """
    Only for Class based view use, check if user has permission to enter the contest, check_type can be details, problems, ranks, submissions
    If verification passes, can get the contest via self.contest in the view
    """
